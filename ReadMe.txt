...
Clone the complete git directory. The code in Double DQN and Proirity sampling is meant for training the flappy bird. An example command to run the code would be: 
